...
```html
<!-- ### ADDITIONAL DATA FIELD ### { 'description': 'Test Post', 'published': '2025-01-03', 'tags': ["Test", "Tester"], 'authors': ["did:plc:krbzbucjaj76xjob6ju47ilo" ], 'category': 'Test', 'pinned': 'true' } ### solutions.konpeki.post.extendedData ### --->
```
...
| Field | Type   | Description                                                                            |
|-------|--------|----------------------------------------------------------------------------------------|
| type  | string | The protocol the post was made on (atproto, fedi)                                      |
| user  | string | The identifier of the user who made the post (Handle and DID accepted)                 |
